...
namespace parse{
    namespace token_type{
        struct Number{int value;};// Лексема «число»
        struct Id{std::string value;};// Лексема «идентификатор»
        struct Char{char value;};// Лексема «символ»
        struct String{std::string value;};// Лексема «строковая константа»
